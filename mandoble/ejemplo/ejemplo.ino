...
#define SERVICE_UUID        "12345678-1234-1234-1234-123456789abc" // Cambiar según necesidades
#define CHARACTERISTIC_UUID "abcdef01-1234-1234-1234-123456789abc" // Cambiar según necesidades
...
// Callback conexión y desconexión
class MyServerCallbacks : public BLEServerCallbacks {
  void onConnect(BLEServer* pServer) {
    Serial.println("Dispositivo conectado");
    deviceConnected = true;
    restartedAfterDisconnect = false; // Reinicia al conectarse
  }
...
void setup() {
  ...
  // Configurar callbacks manejar datos recibidos
  pCharacteristic->setCallbacks(new MyCharacteristicCallbacks());

  // Iniciar el servicio y comenzar
  pService->start();
